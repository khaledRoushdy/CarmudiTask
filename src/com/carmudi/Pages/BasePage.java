...
public class BasePage {
	...
	public void driverImplicitWait(long seconds){
		driver.manage().timeouts().implicitlyWait(seconds, TimeUnit.SECONDS);
	}
	
	public List<String> getAlertNotificationsMessages(){
		
		//wait until the alert notification is shown
		fluentWait(driver.findElement(By.xpath("//div[@class='alert-box notification']")));
		List<WebElement> alertNotificationLocator=driver.findElements(By.xpath("//div[@class='alert-box notification']/strong"));
		List<String> alertNotificationsMessages=new ArrayList<String>();
		for (WebElement element:alertNotificationLocator){
			alertNotificationsMessages.add(element.getText());
		}
		return alertNotificationsMessages;
	}
